...
from SNN_Only.SNN_only_trainingSetOne import   contrastive_loss
from creatingPairsForTrainingSetOne import trainingSetOne


def get_similarity_scores():
    # Load the saved model
    model = load_model('SNN_trainingSetOne.keras',
...
if __name__ == '__main__':
    ...
    print(scores)
    with open("SNN_Only_similarity_scoresTrainingSetOne.txt", "w") as file:
        for score in scores:
            file.write(f"{score}\n")
