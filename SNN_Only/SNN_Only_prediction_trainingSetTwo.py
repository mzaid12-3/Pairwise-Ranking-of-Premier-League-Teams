...
from SNN_Only.SNN_Only_trainingSetTwo import   contrastive_loss
from creatingPairsForTrainingSetTwo import trainingSetOne


def get_similarity_scores():
    # Load the saved model
    model = load_model('SNN_trainingSetTwo.keras',
...
if __name__ == '__main__':
    ...
    print(scores)
    with open("SNN_Only_similarity_scoresTrainingSetTwo.txt", "w") as file:
        for score in scores:
            file.write(f"{score}\n")
