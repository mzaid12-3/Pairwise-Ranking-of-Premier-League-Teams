...
print(scores)
# Sorting teams based on their scores
team_ids = [11, 8, 3, 14, 30, 22, 7, 5, 15, 27, 19, 12, 6, 2, 1, 16, 23, 29, 25, 9]
# Flatten team_pairs to have a simple list of teams in the order they appear in the scores array
...
with open("predicted_rankingsTrainingSetOne.txt", "w") as file:
