...
from SNN_and_XGBoost.SNN_for_XGBoostTrainingSetTwo import contrastive_loss
from SNN_and_XGBoost.creatingPairsForTrainingSetTwo_SNNXGBoost import trainingSetOne


def get_similarity_scores():
    # Load the saved model
    model = load_model('best_siamese_model_forXGBoost_trainingSetTwo.keras',
...
if __name__ == '__main__':
    ...
    print(scores)
    with open("SNN_XGBoost_similarity_scores_trainingSetTwo.txt", "w") as file:
        for score in scores:
            file.write(f"{score}\n")
