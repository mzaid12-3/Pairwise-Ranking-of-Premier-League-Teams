...
with open('SNN_XGBoost_similarity_scores_trainingSetTwo.txt', 'r') as f:
    similarity_scoresTrainingSetOne = [float(line.strip()[1:-1]) for line in f.readlines()]


bst = xgb.Booster()
bst.load_model('SNN_XGBoosttrainingSetTwo.xgb')
...
with open("predicted_ranks_trainingSetTwo.txt", "w") as file:
