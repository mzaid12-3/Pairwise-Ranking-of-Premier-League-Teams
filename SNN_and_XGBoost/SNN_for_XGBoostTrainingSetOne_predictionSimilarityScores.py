...
from SNN_and_XGBoost.SNN_for_XGBoost_trainingSetOne import contrastive_loss
from SNN_and_XGBoost.creatingPairsForTrainingSetOne_SNNXGBoost import trainingSetOne


def get_similarity_scores():
    # Load the saved model
    model = load_model('best_siamese_model_forXGBoost_trainingSetOne.keras',
...
if __name__ == '__main__':
    ...
    print(scores)
    with open("SNN_XGBoost_similarity_scores_trainingSetOne.txt", "w") as file:
        for score in scores:
            file.write(f"{score}\n")
