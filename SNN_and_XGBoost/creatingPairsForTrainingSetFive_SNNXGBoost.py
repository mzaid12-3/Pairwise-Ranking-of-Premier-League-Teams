...
def trainingSetOne():
    ...
    # 2021/22
    team_to_rank_2021_22 = {}
    actual_rankings_2021_22 = data_preprocessed_data_2021_2022['team identifier'].values
    for team, rank in zip(data_preprocessed_data_2021_2022['team identifier'], actual_rankings_2021_22):
        team_to_rank_2021_22[team] = rank

    # Compute the labels using difference in rankings for 2012/13 season
    team_pairs_2021_2022, pairs_2021_2022, labels_2021_2022 = compute_labels_using_rank_difference(
        data_preprocessed_data_2021_2022,
        team_to_rank_2021_22)
    flattened_pairs_2021_2022 = pairs_2021_2022.reshape(pairs_2021_2022.shape[0], -1)



    combined_team_pairs = (team_pairs + team_pairs_2013_2014 + team_pairs_2014_2015 + team_pairs_2015_2016 +
                           team_pairs_2016_2017 + team_pairs_2017_2018+team_pairs_2018_2019+ team_pairs_2019_2020+
                           team_pairs_2020_2021+ team_pairs_2021_2022)

    combined_pairs_trainingSetOne = np.concatenate((pairs, pairs_2013_14, pairs_2014_15, pairs_2015_16, pairs_2016_17,
                                                    pairs_2017_18, pairs_2018_2019, pairs_2019_2020, pairs_2020_2021, pairs_2021_2022), axis=0)

    combined_labels_trainingSetOne = np.concatenate((labels, labels_2013_14, labels_2014_15, labels_2015_16, labels_2016_17,
                                                     labels_2017_18, labels_2018_2019, labels_2019_2020, labels_2020_2021, labels_2021_2022), axis=0)
    combined_pairs_trainingSetOneXGB = np.concatenate((flattened_pairs, flattened_pairs_2013_14, flattened_pairs_2014_15, flattened_pairs_2015_16,
                                                       flattened_pairs_2016_17, flattened_pairs_2017_18, flattened_pairs_2018_2019, flattened_pairs_2019_2020,flattened_pairs_2020_2021,
                                                       flattened_pairs_2021_2022), axis=0)
    print("shape from function:    " ,combined_pairs_trainingSetOneXGB.shape)
