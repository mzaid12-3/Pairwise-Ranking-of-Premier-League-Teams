...
class SaveArraysCallback(tf.keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        if epoch ==49:
            np.savetxt(f'activations_a_epoch_trainingSetFive{epoch}.txt', activations_a)
            np.savetxt(f'activations_b_epoch_trainingSetFive{epoch}.txt', activations_b)
...
best_model.save('best_siamese_model_forXGBoost_trainingSetFive.keras')
